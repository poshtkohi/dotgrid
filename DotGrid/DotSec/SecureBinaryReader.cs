...
namespace DotGrid.DotSec
{
	...
	public class SecureBinaryReader/* : IDisposable*/ 
	{
		...
		public virtual int Read(byte[] value, int index, int count) 
		{
			...
			/*if(rijndael == null)
			{
				return m_stream.Read(value, index, count);
			}*/
			if(rijndael == null)
			{
				if(count <= DataSize)
		...
		public virtual byte ReadByte() 
		{
			...
			if(!fromDownloadDirectoryClient)
				if(rijndael == null)
		...
		private bool fromDownloadDirectoryClient = false;
		/// <summary>
		/// 
		/// </summary>
		public bool FromDownloadDirectoryClient
		{
			set
			{
				fromDownloadDirectoryClient = value;
			}
		}
		//**************************************************************************************************************//
