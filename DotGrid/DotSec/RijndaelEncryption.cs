...
namespace DotGrid.DotSec
{
	...
	public class  RijndaelEncryption
	{
		...
		public RijndaelEncryption(int KeySize)
		{
		...
		public int ExportKeyToFile(string filename)
		{
			...
			else
			{
				try
				{
					...
					string content = "(Key:" +  RijndaelEncryption.BinaryToBase64String(this.Key, this.Key.Length) +
						")     (IV:" + RijndaelEncryption.BinaryToBase64String(this.IV, this.IV.Length) + ")";
					UTF8Encoding utf8 = new UTF8Encoding();
